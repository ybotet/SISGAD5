...
//Trabajador - TrabajoTrabajadores
Trabajador.hasMany(TbTrabajoTrabajadores, { foreignKey: 'id_trabajador', as: 'tb_trabajo_trabajadores' });
TbTrabajoTrabajadores.belongsTo(Trabajador, { foreignKey: 'id_trabajador', as: 'tb_trabajador' });
